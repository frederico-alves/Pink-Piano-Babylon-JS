const buildKey = function (scene, parent, props) {
    if (props.type === "white") {
        ...
        */
        ...
        key.parent = parent;
/* ++++++++++++++++++++++++++++++++++++++++++++++ */
        // Assign pink material to key
        const pinkMat = new BABYLON.StandardMaterial("pink");
        pinkMat.diffuseColor = new BABYLON.Color3(1, 1, 1);
        key.material = pinkMat;
/* ++++++++++++++++++++++++++++++++++++++++++++++ */
...
const createScene = async function(engine) {
    ...
    BABYLON.SceneLoader.ImportMesh("frame", "https://raw.githubusercontent.com/MicrosoftDocs/mixed-reality/docs/mixed-reality-docs/mr-dev-docs/develop/javascript/tutorials/babylonjs-webxr-piano/files/", "pianoFrame.babylon", scene, function(meshes) {
        ...
        frame.parent = piano;
/* ++++++++++++++++++++++++++++++++++++++++++++++ */
        // Assign pink material to piano frame
        frame.material.diffuseColor = new BABYLON.Color3(1, 0, 1);
/* ++++++++++++++++++++++++++++++++++++++++++++++ */
    });
